...
public class TestData {
  ...
  public static List<Ingredient> getPreDefinedItems() {
    return List.of(
        ...
        new Ingredient("Milk", 3, "dL", 10.0, LocalDate.of(2024, 12, 20)),
        new Ingredient("Butter", 250, "grams", 0.1, LocalDate.of(2024, 12, 15)),
        new Ingredient("Flour", 1000, "grams", 0.03, LocalDate.of(2024, 12, 9)),
        new Ingredient("Apple", 5, "pcs", 7.0, LocalDate.of(2024, 12, 9)),
        new Ingredient("Baking soda", 250, "grams", 0.1, LocalDate.of(2024, 12, 24)),
        new Ingredient("Sugar", 1000, "grams", 0.02, LocalDate.of(2024, 12, 20)),
  ...
  public static List<Recipe> getPreDefineRecipes() {
    return List.of(
        ...
        new Recipe(
            "Scrambled eggs",
            "Scrambled eggs with milk, butter and chives",
